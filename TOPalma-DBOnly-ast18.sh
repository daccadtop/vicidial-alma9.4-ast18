...
echo "TOP DIALER DBM installation AlmaLinux/RockyLinux"
...
<META HTTP-EQUIV=REFRESH CONTENT="1; URL=/admin/main.php">
WELCOME
...
UPDATE servers set server_id='TOPIT', server_description='TOP Dialer MAIN', conf_engine='CONFBRIDGE';
quit
MYSQLCREOF
